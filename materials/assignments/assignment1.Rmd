...
## Reflectance calibratin vs. non-reflectance calibration 
...
We've already created PPK-corrected mosaics for 8/3/20 , both with and without reflectance calibration (ON CLASS SHARE). We need to first do the same for the 7/21/20 images.

Step 1. In Pix4D, process the PPK-corrected images for 7/21/20, first with reflectance calibration, then without reflectance calibration (pressing "Reset" for the calibration images). You can find the PPK-corrected images for 7/21/20 on the [class share](https://clarkuedu-my.sharepoint.com/:f:/g/personal/mcecil_clarku_edu/EvX9FJhGeftDrtH7VgB3lToBI9cs3FFJUQqRmkTp2lifqA?e=6BIP1M).
...
Your final submission should be a single R markdown file. Please send this file on Slack to a group with yourself, Mike Cecil, and Laurence SanBoeuf.