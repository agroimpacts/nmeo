...
- Use this block of code to define the area of interest:
    ...
    ```
- Load in the Landsat-8 TOA reflectance ("LANDSAT/LC08/C02/T1_TOA") and Sentinel-2 surface reflectance ("COPERNICUS/S2_SR") collections.  We used TOA for Landsat because the surface reflectance collection only has 4 time points over this area. 
