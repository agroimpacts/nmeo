...
---
## Let's compare Mark and Sentinel-2 NDVI time-series
- Open Anaconda Navigator
- Open JupyterLabs
- Open materials --> code --> Python --> Mark_S2_comparison.ipynb
...
- (demo) work through questions at end of Jupyter Labs
