...
---
background-image: url(figures/02/current_scales.png)
background-size: 80%
...
---
background-image: url(figures/02/geowiki.png)
background-size: 60%
...
---
background-image: url(figures/02/gaveau_etal2014.png)
background-size: 60%
background-position: center
...
![Luo et al (2018): STAIR](figures/02/luo_etal2018.png)
...
---
background-image: url(figures/02/ll_debatsetal_slide.png)
background-size: 50%
background-position: bottom
...
---
background-image: url(figures/02/activelearning.png)
background-size: 50%
background-position: bottom
...
![Global Surface Water](figures/02/global_surface_water.png)
