...
Run the following Earth Engine analyses from Google Colab:

- Create a new colab notebook called "yourname287387" (replace with your actual name)
- Define an AOI over a region of interest in Zambia
- Load in the Sentinel 2 collection
- Filter the collection to your AOI and to the dates 2021-01-01 and 2021-12-31
- Apply a cloud mask to your filtered collection, translating the javascript below to `python`: 
...
---
- Calculate NDVI over the masked collection (note Sentinel-2 has different bands than Landsat for red and NIR--find the right ones), and crop to your AOI;
- Calculate the median NDVI value from your filtered collection;
- Plot a time series NDVI chart from the collection;
- Share the completed notebook with me
